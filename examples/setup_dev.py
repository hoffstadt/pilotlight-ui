...
with open('../.vscode/launch.json', 'w') as file:
    ...
    if platform.system() == "Windows":
        ...
        lines.append('      "program": "${workspaceFolder}/examples/out/win32_vulkan_example.exe",')
        lines.append('      "console": "integratedTerminal",')

    elif platform.system() == "Darwin":
        lines.append('      "name": "(lldb) Launch",')
        lines.append('      "type": "cppdbg",')
        lines.append('      "program": "${workspaceFolder}/examples/out/osx_metal_example",')
        ...
        lines.append('      "name": "(lldb) Launch",')
        lines.append('      "type": "cppdbg",')
        lines.append('      "program": "${workspaceFolder}/examples/out/x11_vulkan_example",')

    lines.append('      "request": "launch",')
    lines.append('      "args": [],')
    lines.append('      "stopAtEntry": false,')
    lines.append('      "cwd": "${workspaceFolder}/examples/out/",')
